...
// (DO NOT EDIT: machine generated header) 'LbClass.pas' rev: 32.00 (Linux)
...
public:
	unsigned __fastcall DecryptBuffer(const void *InBuf, long InBufSize, void *OutBuf);
	unsigned __fastcall EncryptBuffer(const void *InBuf, long InBufSize, void *OutBuf);
...
public:
	inline long __fastcall  Read(System::TArray__1<System::Byte> Buffer, long Offset, long Count){ return System::Classes::TCustomMemoryStream::Read(Buffer, Offset, Count); }
	...
	inline long __fastcall  Write(const System::TArray__1<System::Byte> Buffer, long Offset, long Count){ return System::Classes::TMemoryStream::Write(Buffer, Offset, Count); }
...
public:
	inline long __fastcall  Read(System::TArray__1<System::Byte> Buffer, long Offset, long Count){ return System::Classes::THandleStream::Read(Buffer, Offset, Count); }
	inline long __fastcall  Read(System::TArray__1<System::Byte> &Buffer, long Count){ return System::Classes::TStream::Read(Buffer, Count); }
	inline long __fastcall  Write(const System::TArray__1<System::Byte> Buffer, long Offset, long Count){ return System::Classes::THandleStream::Write(Buffer, Offset, Count); }
	inline long __fastcall  Write(const System::TArray__1<System::Byte> Buffer, long Count){ return System::Classes::TStream::Write(Buffer, Count); }
