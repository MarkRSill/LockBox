...
// (DO NOT EDIT: machine generated header) 'LockBoxDR.dpk' rev: 32.00 (Linux)
...
#include <Posix.SysUtsname.hpp>	// (rtl)
#include <Posix.Wchar.hpp>	// (rtl)
#include <Posix.Wctype.hpp>	// (rtl)
#include <System.Internal.ICU.hpp>	// (rtl)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_LOCKBOXDR)
using namespace Lockboxdr;
#endif
#pragma pack(pop)
#pragma option pop
